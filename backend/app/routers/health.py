...
def healthz_details():
    ...
    return {
        ...
        "tests": "118 passed (68 기존 + 50 신규: /privacy·/ai·/competition·/dsz 평가 5종 증빙 + v12.83 location_verified · v12.87 speed_kmh 게이트 · v12.102 USGS earthquake)",
        "scenarios_supported": [
        ...
        "competition_endpoints": {
            ...
            "ai_종합증빙": "/ai/evidence-report",
            "ai_모델카드": "/ai/model-card",
            "ai_학습이력": "/ai/training-history",
            "ai_roc곡선": "/ai/roc-curve",
            "ai_특성중요도": "/ai/feature-importance",
            "ai_시나리오분석": "/ai/scenario-analysis",
            "가명정보결합_증빙": "/privacy/evidence-report",
            "가명정보결합_스펙": "/privacy/pipeline-spec",
            "가명화_데모": "/privacy/pseudonymize",
            "k익명성_데모": "/privacy/k-anonymize",
            "안심구역_증빙": "/dsz/pipeline-report",
            "안심구역_시드데모": "/dsz/seed-demo",
            "안심구역_컴플라이언스": "/dsz/compliance-status",
            "데이터융합_소스": "/fusion/sources",
            "데이터융합_교차로": "/fusion/intersection/{id}",
